package com.bsoft.assistant.common.config;
...
import com.bsoft.assistant.model.vo.message.Users;
        ...
        registration.interceptors(new ChannelInterceptorAdapter() {
            ...
            public Message<?> preSend(Message<?> message, MessageChannel channel) {
                ...
                if (StompCommand.CONNECT.equals(accessor.getCommand())) {
                    ...
                    //否则
                    throw new BusinessException(FailResponseEnum.SOCKET_USER_INVALID);  //报错
                }
                //不是首次连接，已经成功登陆
                return message;
            }
